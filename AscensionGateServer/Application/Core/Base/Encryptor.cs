...
namespace AscensionGateServer
{
    ...
    public sealed  class Encryptor
    {
        ...
        {
            string ciphertex = Utility.Encryption.DESEncrypt(plaintext, ApplicationBuilder._TokenSecretKey, ApplicationBuilder._KcpIV);
            return ciphertex;
        }
        /// <summary>
        /// 对称加密；
        ...
        {
            var tokenStr = Utility.Encryption.HmacSHA256(plaintext, ApplicationBuilder._TokenSecretKey);
            return tokenStr;
        }
        /// <summary>
        /// HmacSHA256加密；
        ...
        public static string Decrypt(byte[] buffer)
        {
            ...
            var plaintext = Utility.Encryption.DESDecrypt(ciphertext, ApplicationBuilder._TokenSecretKey, ApplicationBuilder._KcpIV);
            return plaintext;
        }
        /// <summary>
        /// 对称解密；
