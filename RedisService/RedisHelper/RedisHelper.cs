...
namespace RedisService
{
    public sealed partial class RedisHelper
    {
        ...
        {
            return $"{RedisManager.RedisKeyPrefix}{key}";
        }
        /// <summary>
        /// 非常消耗性能；
        /// 模糊查询K包含目标字段的key；
        ...
        /// <returns></returns>
        public static string[] FuzzyKey(string keyword, byte order, int dbIndex = 0)
        {
        ...
        public static bool FuzzyKeyExist(string keyword, byte order, int dbIndex = 0)
        {
                string word = "";
                switch (order)
                {
        ...
        /// <param name="dbIndex">db的序号</param>
        /// <returns></returns>
        public async static Task<string[]> FuzzyKeyAsync(string keyword, byte order, int dbIndex = 0)
        {
        ...
        public async static Task<bool> FuzzyKeyExistAsync(string keyword, byte order, int dbIndex = 0)
        {
